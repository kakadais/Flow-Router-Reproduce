...
#_.random(1500, 2500) 처럼 무작위크기의 파일을 뽑아주는 유틸리티!!
#Lodash는 개발자가 보다 깨끗하고 효율적이며 읽기 쉬운 코드를 작성하는 데 도움이 되는
# 다양한 기능을 제공하는 인기 있는 JavaScript 유틸리티 라이브러리입니다.
# 여기에는 배열, 객체, 문자열 및 기타 데이터 유형을 조작하기 위한 함수와 함수, 컬렉션 등으로
# 작업하기 위한 유틸리티 함수가 포함됩니다.
@cl = console.log
